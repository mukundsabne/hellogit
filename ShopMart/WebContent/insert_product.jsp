...
<!-- Mirrored from htmlshopmart.justthemevalley.com/account_page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Sep 2017 11:38:49 GMT -->
<head>
<!-- Basic page needs -->
<meta charset="utf-8">
<!--[if IE]>
                  ...
                  <div>
                    <div class="top-cart-content">
                      ...
                      <ul id="cart-sidebar" class="mini-products-list">
                        <li class="item odd"> <a href="shopping_cart.html" title="Product title here" class="product-image"><img src="images/products/product-8.jpg" alt="html Template" width="65"></a>
      ...
      <div class="page-content">
        <div class="account-login">
          <div class="box-authentication">
            ...
            <label for="mainmenu">Main_Menu<span class="required">*</span></label>
            
            <input type="text" id="mainmenu" name="mainmenu" list="mainmenulist" class="form-control"> 
            <datalist id="mainmenulist">
            <option>Electronics</option>
            <option>Men</option>
            <option>Woman</option>
            </datalist>
            <label for="submenu">Sub_Menu<span class="required">*</span></label>
            <input id="submenu" type="text" class="form-control" list="submenuli                    st">
            ...
            <label for="productname">Name of Product<span class="required">*</span></label>
            ...
            <input id="discountamount" type="text" name="discountamount" class="form-control" readonly="readonly">
            
            <label for="quantity">Quantity<span class="required">*</span></label>
            <input id="quantity" type="text" name="quantity" class="form-control">
            
            <button class="button"><i class="icon-lock icons"></i>&nbsp; <span>ADD PRODUCT</span></button>
